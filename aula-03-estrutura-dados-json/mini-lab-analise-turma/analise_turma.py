# analise_turma.py
# Mini-lab Aula 03 — Sistema de Análise de Turma
...
# Definir caminhos relativos ao arquivo do script
DIRETORIO_ATUAL = os.path.dirname(os.path.abspath(__file__))
ARQUIVO_JSON = os.path.join(DIRETORIO_ATUAL, 'turma.json')
ARQUIVO_SAIDA = os.path.join(DIRETORIO_ATUAL, 'relatorio.json')
...
try:
    ...
    print('Crie o arquivo turma.json na pasta do projeto.')
    sys.exit(1)
...
relatorio = {
    ...
    'cursos': sorted(list(cursos_vistos)),  # set → list ordenada
