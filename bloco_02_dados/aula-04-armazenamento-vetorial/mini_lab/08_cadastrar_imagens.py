...
print("Carregando modelo CLIP de IA (isso pode demorar na primeira vez)...")
...
try:
    ...
    for item in imagens_exemplo:
        ...
        urllib.request.urlretrieve(item["url"], "temp_img.jpg")
        ...
        print(f"✅ Imagem processada e salva: {item['titulo']}")
    ...
    print("Todas as imagens foram cadastradas com sucesso!")
